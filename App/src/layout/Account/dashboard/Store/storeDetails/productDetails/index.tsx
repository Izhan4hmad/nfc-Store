...
const currentCart = JSON.parse(localStorage.getItem('cartItems') ?? '[]');
    ...
    if (existingItemIndex >= 0) {
      ...
      updatedCart = [
        ...currentCart,
        {
          ...
          quantity: quantity,
          price: selectedVariant?.resellingPrice || 0,
    ...
    // Save to localStorage and navigate to cart
    localStorage.setItem('cartItems', JSON.stringify(updatedCart));
    navigate(`/account/${company_id}/${planId}/${locationId}/${userId}/cart`, { state: { cartItems: updatedCart } });
  }}
