...
export default function StorePage() {
    ...
    const { userId, company_id, planId, locationId } = useParams();
        ...
        return items
            .filter((item) => {
                ...
                if (activeTab === 'customizableProducts') {
                    return matchesSearch && matchesPrice && isCustomizable;
                }
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300 overflow-hidden group">
                ...
                <div className="p-4">
                    ...
                    <div className="flex gap-2">
                        <button
                            onClick={() => navigate(`/account/${company_id}/${planId}/${locationId}/${userId}/store/product/${product?.productId}`)}
        ...
        return (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300 overflow-hidden group">
                ...
                <div className="p-4">
                    ...
                    <div className="flex gap-2">
                        <button
                            onClick={() => navigate(`/account/${company_id}/${planId}/${locationId}/${userId}/store/custom-product/${product?.productId}`)}
                            className="flex-1 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors font-medium flex items-center justify-center gap-2"
                        >
                            <Eye className="h-4 w-4" />
                            View Details
        ...
        return (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300 overflow-hidden group">
                ...
                <div className="p-4">
                    ...
                    <div className="flex gap-2">
                        <button
                            onClick={() => navigate(`/account/${company_id}/${planId}/${locationId}/${userId}/store/bundle/${bundle?.bundleId}`)}
                            className="flex-1 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors font-medium flex items-center justify-center gap-2"
                        >
                            <Eye className="h-4 w-4" />
                            View Details
