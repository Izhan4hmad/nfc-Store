...
import CustomizationModal from './createDesign';
...
export default function CustomProductDetailPage() {
    ...
    const handleSaveCustomization = async (customizationData: CustomizationData) => {
        ...
        try {
            const customizedVariant: Variant = {
                ...
                resellingPrice: customizationData.resellingPrice || selectedVariant.resellingPrice,
    ...
    const calculatePricing = () => {
        ...
        const resellPrice = selectedVariant.resellingPrice || 0;
        const profit = resellPrice - unitPrice;
    ...
    const { unitPrice, resellPrice, profit, profitPercentage } = calculatePricing();
    // Loading State
    if (loading) {
        return (
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-3 bg-gray-50 p-4 rounded-lg border border-gray-200">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-lg font-bold text-gray-900">${resellPrice.toFixed(2)}</span>
                            </div>
                        ...
                        {product.customizable && (
                            <div className="flex-1 ">
                                <button
                                    ...
                                    className="w-full bg-orange-600 text-white px-6 py-3 rounded-lg hover:bg-orange-700 transition-colors font-medium flex items-center justify-center gap-2 mb-3"
                                >
                                    <Palette className="h-5 w-5" />
                                    Customize Your Design
                                </button>
                                <p className="text-sm text-gray-600 text-center">Add your personal touch with custom colors, text, and logo</p>
                            </div>
                        )}
