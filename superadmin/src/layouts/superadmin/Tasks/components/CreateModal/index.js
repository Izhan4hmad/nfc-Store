...
const CreateModal = ({ staff, handleRefresh, apps, appData, ghlFeatures, team, tags, jobs }) => {
  ...
  function AddProduct({ open, onClose }) {
    ...
    return (
      <MDModal open={open} onClose={onClose} width={440} >
        <MDBox component="form" onSubmit={handleSubmit} role="form" sx={style} height={770} style={{ overflow: "auto" }}>
          ...
          <MDBox>
            ...
            <Multiselect data={jobOptions} isMulti={true} name="jobs" />
          </MDBox>
          <MDBox>
            <MDTypography variant="button" sx={{ fontSize: '12px', fontWeight: '500' }} mb={1}>
              Points
          ...
          <MDBox>
            ...
            <Multiselect data={ghlfeaturesOptions} edit_data={[]} isMulti={true} name="ghl_features" />
          </MDBox>
          ...
          <MDBox>
            ...
            <Multiselect data={teamOptions} edit_data={[]} isMulti={true} name="team" />
          </MDBox>
          <MDBox>
            <MDTypography variant="button" sx={{ fontSize: '12px', fontWeight: '500' }} mb={1}>
              Tags
            </MDTypography>
            <Multiselect data={tagsOptions} edit_data={[]} isMulti={true} name="staff_tag" />
          </MDBox>
