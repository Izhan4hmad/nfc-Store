            ...
            >
                ...
                <div className="overflow-y-auto overflow-x-hidden perfect-scrollbar h-full">
                    ...
                    <div className="border border-dashed border-white-light dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                        ...
                        <div className="grid grid-cols-3 gap-2 mt-3">
                            <button type="button" className={`btn-primary btn`} onClick={() => dispatch(toggleMenu('horizontal'))}>
                                Horizontal
                            </button>
                            <button type="button" className={`btn-primary btn`} onClick={() => dispatch(toggleMenu('vertical'))}>
                                Vertical
                            </button>
                        </div>
