...
const LocationHeader = () => {
    ...
    const Menus = [
        { title: 'Dashboard', icon: <MdDashboard />, route: 'dashboard', key: 'dashboard' },
        { title: 'Messages', icon: <MdMessage />, route: 'message', key: 'message' },
        { title: 'Devices', icon: <HiDevicePhoneMobile />, route: 'devices', key: 'devices' },
    ];
    return (
